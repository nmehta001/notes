...
When it budgeting there are two sides to focus on:
...
The code comprises of four numbers and one or two letters:
...
- P60:
  ...
  - Received from an employer within two months of each tax year end date (5 April).
...
- If you’re paying for a gym and don’t go often, see if you can do pay as you go instead
