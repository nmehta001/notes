...
| Term                                          | Definition                                                                                                                           |
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| Active members                                | People who are actively contributing to a pension scheme                                                                             |
...
| Annuity                                       | A guaranteed income given by an insurance company in exchange for the value of your pension pot.                                     |
...
| Inheritance Tax                               | A UK tax on inherited money, property and other assets.                                                                              |
...
| Longevity                                     | Life expectancy (in demography) or living to an old age.                                                                             |
...
| Means-tested                                  | Payments, such as state benefits, which are dependent on the assessment of an applicant’s income or other resources.                 |
...
| Private sector                                | The part of the economy not under state control.                                                                                     |
| Progressive tax                               | A tax where the amount paid as a proportion of gross income increases as income rises                                                |
| Public sector                                 | The part of the economy under state control.                                                                                         |
...
| State Earnings Related Pension Scheme (SERPS) | A supplementary state pension to the ‘old’ basic state pension.                                                                      |
...
| Workplace pension scheme                      | Provided by an employer to eligible employees ( automatically enrolled onto the scheme unless they opt out).                         |
